export function initOrbit() {
    // 1. Pengecekan Utama (Mencegah error di halaman yang tidak punya orbit)
    const orbitRing = document.getElementById('orbit-ring');
    if (!orbitRing) return;

    // 2. Data Komponen (Lengkap, tidak disingkat)
    const nodesData = [
        {
            id: 'step3_1', // Sedikit penyesuaian agar ID unik, sebelumnya ada dua 'step3'
        ...
        {
            id: 'step4', 
            label: 'Kerja dan Kuliah Luar Negeri', 
            baseAngle: 216,
            icon: '4',
    ...
    // 3. Setup Referensi DOM tambahan
    ...
    // 4. Render Node Komponen ke dalam DOM
    ...
    // 7. Update Gaya Visual (Style) Node
